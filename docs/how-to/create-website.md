...
1) Клонируем созданный репозиторий и переходим в папку проекта
```console
$ git clone <ваш репозиторий>
$ cd <название вашего репозитория>
```

2) Создаем виртуальное окружение python и активируем его
```console
$ python3 -m venv .
$ source venv/bin/activate
```
3) Устанавливаем утилиту mkdocs
```
...
mkdocs new .
```
5) Настраиваем mkdocs.yml (минимально)
```
site_name: My Docs
...
3) Оформляешь страницы как хочешь, но в языке Markdown
```# 🚀 Как создать сайт
